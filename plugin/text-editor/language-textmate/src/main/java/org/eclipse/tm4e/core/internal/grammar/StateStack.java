...
public final class StateStack implements IStateStack {
	...
	// Rewritten from a Java 17 record to a plain final class because R8 9.2.x emits a
	// `RecordTag` reference without the corresponding class, causing NoClassDefFoundError
	// at load time on Android.
	@NonNullByDefault({})
	static final class Frame {
		final RuleId ruleId;
		@Nullable
		final Integer enterPos;
		@Nullable
		final Integer anchorPos;
		...
		Frame(
				final RuleId ruleId,
				@Nullable final Integer enterPos,
				@Nullable final Integer anchorPos,
				final boolean beginRuleCapturedEOL,
